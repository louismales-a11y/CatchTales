                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('Dream Mode', style: TextStyle(fontWeight: FontWeight.w600)),
                        Text(
                          'Underwater background with swimming fish (dark mode only)',
                  ...
                  ValueListenableBuilder<String>(
                    ...
                    builder: (ctx, skin, _) => Switch(
                      value: skin == 'fancy',
                      onChanged: (v) => SkinService.instance.setSkin(v ? 'fancy' : 'classic'),
                    ),
                  ),
                ],
              ),
